...
from lib.core.config import AMASS_REND_DIR

class AmassRend(Dataset3D):
    def __init__(self, set, seqlen, overlap=0.75, debug=False):
        db_name = 'amass_rend_take3'
        # amass_render_take3_db
        ...
        super(AmassRend, self).__init__(
            set=set,
            folder=AMASS_REND_DIR,
            seqlen=seqlen,
            overlap=overlap,
