...
def main(args):
    ...
    all_file_list = glob(osp.join(args.ntu_vibe_dir, f'{args.ntu_class}/*.pkl'))
    ...
    TRAIN_OUTPUT_FILENAME = f'train_vibe_ntu_{args.ntu_class}.pkl'
    TEST_OUTPUT_FILENAME = f'test_vibe_ntu_{args.ntu_class}.pkl'
    EMPTY_OUTPUT_FILENAME = f'empty_vibe_ntu_{args.ntu_class}.lst'
    ERROR_OUTPUT_FILENAME = f'error_vibe_ntu_{args.ntu_class}.lst'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ntu_class', type=str,
                        help='Name of the class to be extracted, e.g. A001')
    ...
    parser.add_argument('--exclude_mutual_actions', type=bool, default=True,
                        help='Does not include the classes that have two persons')
